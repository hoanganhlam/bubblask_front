...
"use strict";
/* harmony import */ var _utils_config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/board/index.vue?vue&type=template&id=120d0fec&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"section\">","</div>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"level is-mobile\">","</div>",[_vm._ssrNode("<div class=\"level-left\"><h1 class=\"title is-spaced\">Board</h1></div> "),_vm._ssrNode("<div class=\"level-right\">","</div>",[(_vm.currentUser)?_vm._ssrNode("<div class=\"button is-light\">","</div>",[_c('x-icon',{attrs:{"name":"plus"}}),_vm._ssrNode(" <span>Create</span>")],2):_vm._e()])],2),_vm._ssrNode(" <div class=\"subtitle\">Get or sharing template to learn something by expert!</div> "),(_vm.query.page === 1)?_vm._ssrNode("<div>","</div>",[(_vm.currentUser)?_c('board-list'):_vm._e()],1):_vm._e(),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"subsection\">","</div>",[_vm._ssrNode("<h2 class=\"title has-text-centered\">Template</h2> "),_vm._ssrNode("<div class=\"field\">","</div>",[_vm._ssrNode("<div class=\"control\">","</div>",[_c('b-input',{attrs:{"type":"search","placeholder":"Learn something"}})],1)]),_vm._ssrNode(" "+((_vm.taxonomies.length)?("<div class=\"buttons\">"+(_vm._ssrList((_vm.taxonomies),function(tax){return ("<a"+(_vm._ssrAttr("href",("/board/?tag=" + (tax.id))))+(_vm._ssrClass("button is-small",{'is-primary': _vm.tag && _vm.tag.id === tax.id}))+">"+_vm._ssrEscape(_vm._s(tax.title))+"</a>")}))+"</div>"):"<!---->")+" <div class=\"level is-mobile\"><div class=\"level-left\"><h4 class=\"widget_title\">List</h4></div> <div class=\"level-right\"><div class=\"buttons\"><div"+(_vm._ssrClass("button is-small",{'is-static': _vm.query.page === 1}))+">\n                                Previous\n                            </div> <div"+(_vm._ssrClass("button is-small",{'is-static': _vm.response.count / _vm.query.page_size <= _vm.query.page}))+">Next\n                            </div></div></div></div> "),(_vm.response.results.length)?_vm._ssrNode("<div class=\"columns is-multiline\">","</div>",_vm._l((_vm.response.results),function(board){return _vm._ssrNode("<div class=\"column is-4\">","</div>",[_vm._ssrNode("<div class=\"media box clickable template-board\">","</div>",[_vm._ssrNode("<div class=\"media-left\">","</div>",[_c('avatar',{staticClass:"is-48x48",attrs:{"value":board.media}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"media-content\">","</div>",[_vm._ssrNode("<h4 class=\"widget-title\">","</h4>",[_c('n-link',{attrs:{"to":("/board/" + (board.slug))}},[_vm._v(_vm._s(board.title))])],1),_vm._ssrNode(" <p>"+_vm._ssrEscape(_vm._s(board.description))+"</p> <small>3 Tasks</small>")],2)],2)])}),0):_vm._ssrNode(("<div class=\"columns is-multiline\">"+(_vm._ssrList((_vm.query.page_size),function(i){return ("<div class=\"column is-4\"><div class=\"box\"><div class=\"skeleton-board\"></div></div></div>")}))+"</div>"))],2)],2)])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/board/index.vue?vue&type=template&id=120d0fec&
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _helpers_configs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
const _05ac3a00 = () => interopDefault(__webpack_require__.e(/* import() | pages/leaderboard/index */ 5).then(__webpack_require__.bind(null, 67)));

const _02b3de70 = () => interopDefault(__webpack_require__.e(/* import() | pages/privacy */ 6).then(__webpack_require__.bind(null, 68)));

const _423af794 = () => interopDefault(__webpack_require__.e(/* import() | pages/board/_id/index */ 2).then(__webpack_require__.bind(null, 69)));

const _be0f8fe8 = () => interopDefault(__webpack_require__.e(/* import() | pages/board/_id/mindmap */ 3).then(__webpack_require__.bind(null, 70)));

const _171029dc = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 4).then(__webpack_require__.bind(null, 71)));

const _6b302c26 = () => interopDefault(__webpack_require__.e(/* import() | pages/_user/index */ 1).then(__webpack_require__.bind(null, 66))); // TODO: remove in Nuxt 3
...
var default_component = Object(componentNormalizer["a" /* default */])(
  ...
  defaultvue_type_template_id_1c7e1d38_render,
  defaultvue_type_template_id_1c7e1d38_staticRenderFns,
  false,
...
// EXTERNAL MODULE: ./components/utils/config.js
var utils_config = __webpack_require__(2);
...
//
//
const Taskvue_type_script_lang_js_ = __webpack_require__(4);
...
var Task_component = Object(componentNormalizer["a" /* default */])(
  ...
  Taskvue_type_template_id_33a90cc1_render,
  Taskvue_type_template_id_33a90cc1_staticRenderFns,
  false,
  Task_injectStyles,
  null,
  "62865b9d"
