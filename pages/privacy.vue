        ...
        <div class="container content">
            <div class="card">
                <div class="card-content">
                    ...
                    <p>At Bubblask, accessible from https://bubblask.com, one of our main priorities is the privacy of our visitors.
                    ...
                    <h2>Log Files</h2>
                    <p>Bubblask follows a standard procedure of using log files. These files log visitors when they visit websites.
                    ...
                    <p>Like any other website, Bubblask uses 'cookies'. These cookies are used to store information including
                    ...
                    <p>For more general information on cookies, please read <a
                        href="https://en.wikipedia.org/wiki/HTTP_cookie">"What Are Cookies"</a>.</p>
                    ...
                    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Bubblask.</p>
                    ...
                    <p>Note that Bubblask has no access to or control over these cookies that are used by third-party
                        advertisers.</p>
                    <h2>Third Party Privacy Policies</h2>
                    <p>Bubblask's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
                    ...
                    <p>Bubblask does not knowingly collect any Personal Identifiable Information from children under the age of 13.
